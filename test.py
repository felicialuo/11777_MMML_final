...
def contrastive_loss(video_feat, text_feat, device = 'cpu'):
        ...
        print(video_feat.shape, text_feat.shape, labels.shape)
...
def eval(model, test_loader, device, epoch, id_mapping, seen=True):
    ...
    if seen:
        ...
        total_loss / total_batch, total_correct, test_loader.dataset.num_videos,
        100. * total_correct / test_loader.dataset.num_videos))
    else:
